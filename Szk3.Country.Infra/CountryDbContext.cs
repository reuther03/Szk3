...
public class CountryDbContext : PlatformDbContext, Application.Common.ICountryContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        optionsBuilder.UseSqlServer(@"server=localhost\SQLEXPRESS;database=country-dev;trusted_connection=true;TrustServerCertificate=True;", x => x.MigrationsHistoryTable("__EFMigrationsHistory", DbConst.SCHEMA_NAME));
